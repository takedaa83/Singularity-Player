...
class SearchService {
    ...
    static CACHE_MAX_SIZE = 200; // Maximum cached queries
    ...
    static SUGGESTIONS_CACHE_TTL = 2 * 60 * 1000; // 2 minutes
    static MAX_SUGGESTIONS_CACHE = 200;
    /**
     ...
     */
    static async fetchYouTube(query) {
        try {
    ...
    static async fetchDeezer(query) {
        try {
    ...
    static async fetchITunes(query) {
        try {
